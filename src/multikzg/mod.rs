...
use ark_ec::{
    pairing::Pairing as PairingEngine, scalar_mul::variable_base::VariableBaseMSM, AffineRepr,
    CurveGroup,
};
...
#[inline]
fn msm<E: PairingEngine>(bases: &[E::G1Affine], scalars: &[E::ScalarField]) -> E::G1Affine {
...
pub struct EvaluationProofMulti<E: PairingEngine>(pub(crate) Vec<E::G1Affine>);
...
pub struct VerifierKeyMulti<E: PairingEngine> {
...
impl<E: PairingEngine> VerifierKeyMulti<E> {
